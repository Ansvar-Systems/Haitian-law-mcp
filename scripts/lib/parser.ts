...
export function parseHTLawText(text: string, act: ActIndexEntry): ParsedAct {
...
export function parseHTLawPdf(pdfPath: string, act: ActIndexEntry): ParsedAct {
